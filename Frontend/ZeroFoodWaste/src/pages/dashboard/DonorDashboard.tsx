                  ...
                  {isLoading ? (
                    ...
                    <div className="divide-y divide-border">
                      {recentDonations.map((donation, index) => (
                        ...
                        >
                          <Link to={`/donations/${donation._id}`} className="block px-6 py-4">
                              ...
                              <div className="flex items-center gap-4 flex-1">
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center gap-2 mb-0.5">
                                    ...
                                    <Badge
                                      variant="outline"
                                      className={`text-xs flex-shrink-0 ${statusColors[
              ...
              <Card className="border-0 shadow-sm bg-gradient-to-br from-amber-50 to-orange-50 overflow-hidden">
                ...
                <CardContent>
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <p className="font-bold text-foreground">Level {Math.max(1, Math.floor((user?.totalPoints ?? 0) / 100) + 1)} Donor</p>
                ...
                <CardContent className="space-y-2.5 pt-0">
                  {achievements.map((achievement) => (
                    <motion.div
                      ...
                      className={`relative flex items-start gap-3 p-3 rounded-2xl transition-all ${achievement.unlocked
